...
class BaiduTranslateResource
{
    ...
    private $appId = '20181106000230491';
    private $secKey = 'apczfanUxqmLTC4RRtKl';

    public function translateEnToZh($queries = [])
    {
        $query = implode("\n", $queries);
        $result = $this->translate($query, 'en', 'zh');
        return array_column(Arr::get($result, 'trans_result'), 'dst');
    }
